...
(() => {
  ...
  var Xg = { _initSnappableMarkers() {
    ...
    let i = t.target;
    if (i._snapped = false, this.throttledList || (this.throttledList = L.Util.throttle(this._handleThrottleSnapping, 100, this)), t?.originalEvent?.altKey || this._map?.pm?.Keyboard.isAltKeyPressed()) return false;
    let r;
    if (e) {
  ...
  function ol(t) {
    ...
    return n.absoluteValue = n.abs = function() {
      ...
      return q(this);
    }, n._isBigNumber = true, n[Symbol.toStringTag] = "BigNumber", n[/* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom")] = n.valueOf, t != null && _.set(t), _;
  }
  function dt(t) {
    var e = t | 0;
